@echo off
setlocal
REM This file creates the NSA / dotp plots from a skyline id_all.sky
REM Excludes transitions marked as non-quantitative for NSA calculation
...
echo.
set scriptfile="!Reports/gen_dotp_plot.R"
