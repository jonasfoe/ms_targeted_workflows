@echo off
setlocal
REM This file exports id_all_precursors.csv, id_all_transitions.csv, id_all_chromatograms_ms2_top25.csv from id_all.sky
...
"!Skyline Templates\SkylineRunner.exe" ^
	--in="%wd%\id_all.sky" ^
	--report-add="!Skyline Templates\id_all_chromatograms_ms2_top25.skyr" ^
	--report-conflict-resolution=overwrite ^
	--report-format=csv ^
	--report-invariant ^
	--report-name="id_all_chromatograms_ms2_top25" ^
	--report-file="%wd%\id_all_chromatograms_ms2_top25.csv"
